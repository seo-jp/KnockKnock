...
CREATE TABLE USER (
	...
	USER_CREATE TIMESTAMP    NOT NULL DEFAULT now(), -- 생성날짜
...
CREATE TABLE KEYWORD (
	...
	KEY_WORD    VARCHAR(20) NOT NULL  -- 키워드
);
...
CREATE TABLE CONTENT (
	...
	CON_IMG      VARCHAR(100) NULL,     -- 사진
	CON_VIDEO    VARCHAR(100) NULL,     -- 동영상
	CON_CREATE   TIMESTAMP NOT NULL DEFAULT now() -- 생성날짜
);
...
ALTER TABLE KEYWORD_RECORD
	MODIFY COLUMN KR_IDX BIGINT NOT NULL AUTO_INCREMENT;
...
CREATE TABLE TAG (
	...
	TAG_NAME     VARCHAR(30) NOT NULL, -- 태그명
...
ALTER TABLE TAG
	MODIFY COLUMN TAG_IDX INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE COMMENT
	MODIFY COLUMN RE_IDX INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE KNOCK
	MODIFY COLUMN KNOCK_IDX BIGINT NOT NULL AUTO_INCREMENT;
...
CREATE TABLE SEARCH_RECORD (
	...
	SR_CREATE   TIMESTAMP    NOT NULL DEFAULT now() -- 생성날짜
);
...
CREATE TABLE ALARM (
	...
	ALARM_CREATE    TIMESTAMP   NOT NULL DEFAULT NOW(), -- 생성날짜
...
CREATE TABLE MESSAGELIST (
	...
	ML_CREATE   TIMESTAMP NOT NULL DEFAULT NOW(), -- 생성날짜
	ML_UPDATE   TIMESTAMP NOT NULL DEFAULT NOW() -- 업데이트날짜
);
...
CREATE TABLE MESSAGE (
	...
	MSG_PHOTO      VARCHAR(100)  NULL,     -- 사진
	MSG_VIDEO      VARCHAR(100) NULL,     -- 동영상
	MSG_CREATE     TIMESTAMP    NOT NULL DEFAULT NOW() -- 생성날짜
);
...
CREATE TABLE FOLLOWING (
	FI_IDX       INT       NOT NULL, -- IDX
	FI_CREATE    TIMESTAMP NOT NULL DEFAULT NOW(), -- 생성날짜
...
ALTER TABLE FOLLOWING
	MODIFY COLUMN FI_IDX INT NOT NULL AUTO_INCREMENT;
...
CREATE TABLE FOLLOWER (
	...
	FE_CREATE    TIMESTAMP NOT NULL DEFAULT now(), -- 생성날짜
